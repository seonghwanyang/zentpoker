export function Footer() {
  return (
    <footer className="mt-auto glass border-t border-purple-200/20">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* Brand */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold gradient-text">ZentPoker</h3>
        ...
        <div className="mt-8 pt-8 border-t border-purple-200/20">
