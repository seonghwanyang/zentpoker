...
const voucherPrices = {
  BUY_IN: {
    ...
    ADMIN: PRICING.VOUCHER.BUY_IN.REGULAR,  // 관리자는 정회원과 동일한 가격
  },
  RE_BUY: {
    REGULAR: PRICING.VOUCHER.RE_BUY.REGULAR,
    GUEST: PRICING.VOUCHER.RE_BUY.GUEST,
    ADMIN: PRICING.VOUCHER.RE_BUY.REGULAR,   // 관리자는 정회원과 동일한 가격
  },
};
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-sm text-gray-500">
                        보유 포인트: {formatAmount(currentBalance)} P
                      </p>
                    </div>
                  </div>
                  {!hasEnoughBalance && (
          ...
          description={
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500 pt-1">
                구매 후 남은 포인트: {formatAmount(currentBalance - totalPrice)} P
              </p>
            </div>
          }
